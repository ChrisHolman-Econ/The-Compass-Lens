...
The chart below outlines the regional unemployment rate for each of the member counties. The **purple line** establishes the aggregate baseline for the **OWL Corridor**, while **green** indicates Oakland County, **navy** represents Washtenaw County, and **orange** represents Livingston County. While individual county trends appear muted relative to the primary corridor baseline, their alignment underscores how tightly integrated these local economies are.
